 ...
 * @author root
 */
@WebServlet(name = "LucasDeAquinoServlet", urlPatterns = {"/lucas-de-aquino-servlet.html"})
public class LucasDeAquinoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LucasDeAquinoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
